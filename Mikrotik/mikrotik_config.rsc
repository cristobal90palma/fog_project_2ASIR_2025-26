# 2026-05-12 21:25:51 by RouterOS 7.22.1
...
/ip dhcp-client
add interface=ether0 name=client1
/ip dhcp-relay
...
add address-pool=dhcp_pool217 code=60 matching-type=substring name=\
    match-surface217 option-set=set-surface server=vmbr217 value=\
    PXEClient:Arch:00007:UNDI:003016
add address-pool=dhcp_pool217 code=60 matching-type=substring name=\
    match-apple217 option-set=set-apple server=vmbr217 value=AAPLBSDPC/i386
add address-pool=dhcp_pool227 code=60 matching-type=substring name=\
    match-surface227 option-set=set-surface server=vmbr227 value=\
    PXEClient:Arch:00007:UNDI:003016
add address-pool=dhcp_pool227 code=60 matching-type=substring name=\
    match-apple227 option-set=set-apple server=vmbr227 value=AAPLBSDPC/i386
...
add address-pool=dhcp_pool237 code=60 matching-type=substring name=\
    match-surface237 option-set=set-surface server=vmbr237 value=\
    PXEClient:Arch:00007:UNDI:003016
add address-pool=dhcp_pool237 code=60 matching-type=substring name=\
    match-apple237 option-set=set-apple server=vmbr237 value=AAPLBSDPC/i386
/ip dhcp-server network
add address=172.18.10.0/24 dns-server=172.16.200.1,8.8.8.8 gateway=\
    172.18.10.1 next-server=10.2.7.5
